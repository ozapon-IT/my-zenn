...
監視を足すときに先に見たいのは、欠測そのものより、**監視が事故と運命を共有しないこと**です。止めてよい cron と止めてはいけない監視は、インフラ定義で非対称にし、その非対称をテストで固定します。

判定は起動記録ではなく、その朝の成果物です。存在だけでは足りず、読めないときは黙りません。誤検知1回より沈黙1回の方が重い、という非対称です。
